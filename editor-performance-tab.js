...
(() => {
  ...
  function addPerformanceTab() {
    ...
    if (!tabs || performanceButton()) return;
    ...
    button.innerHTML = '<i class="fa-solid fa-gauge-high"></i> 성능 300';
    button.onclick = () => {
      ...
      requestAnimationFrame(() => requestAnimationFrame(() => {
        ...
        button.innerHTML = `<i class="fa-solid fa-gauge-high"></i> 성능 300 <small>${Math.round(elapsed)}ms</small>`;
