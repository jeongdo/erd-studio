...
(() => {
  ...
  [
    ...
    { id:'file.import.mybatis', label:'MyBatis Project Import…', icon:'fa-solid fa-code-branch', run:()=>callGlobal('openMyBatisImport') },
    ...
    { id:'tools.mybatis.index', label:'MyBatis Source Index', icon:'fa-solid fa-code-branch', run:()=>callGlobal('openMyBatisIndex') },
    { id:'tools.mybatis.usage', label:'선택 테이블 Mapper 사용처', icon:'fa-solid fa-code-branch', when:hasSelection, run:()=>callGlobal('showMapperUsage') },
